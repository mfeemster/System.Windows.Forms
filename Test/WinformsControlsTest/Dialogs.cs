...
public partial class Dialogs : Form
{
	...
	public Dialogs()
	{
		...
		var resnames1 = asm.GetManifestResourceNames();
		var ii = resources.GetObject("WinformsControlsTest.Resources.OpenDialog.png");
		ii = resources.GetObject("Resources.OpenDialog.png");
		ii = resources.GetObject("OpenDialog.png");
		var str = asm.GetManifestResourceStream("WinformsControlsTest.Resources.OpenDialog.png");
		var bmp = new Bitmap(str);
		//str = asm.GetManifestResourceStream("Resources.OpenDialog.png");
		//str = asm.GetManifestResourceStream("OpenDialog.png");

		_btnOpen = new ("&Open dialog")
		{
			Image = bmp,//(Bitmap? )resources.GetObject("WinFormsControlsTest.resources.OpenDialog.png"),
			Enabled = false,
		};
		_btnOpen.Click += (s, e) =>
		{
	...
	private void btnColorDialog_Click(object sender, EventArgs e)
	{
		...
		//CustomColorDialog is Windows only.
