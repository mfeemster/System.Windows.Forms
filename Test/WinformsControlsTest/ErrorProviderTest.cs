...
public partial class ErrorProviderTest : Form
{
	...
	private void submitButton_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			MessageBox.Show("Error provider 1 is all right!", "OK", MessageBoxButtons.OK, MessageBoxIcon.Information);
		}
		...
		else
		{
			...
			MessageBox.Show("Error provider 2 is all right!", "OK", MessageBoxButtons.OK, MessageBoxIcon.Information);
		}
	}
}
