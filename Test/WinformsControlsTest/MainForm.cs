...
public partial class MainForm : Form
{
	...
	protected override void OnShown(EventArgs e)
	{
		...
		//var bmp = new Bitmap("./Images/LargeA.bmp");
	...
	private void UpdateLayout()
	{
		...
		//Getting the right size is behaving very strangely. This is a hack to at least get the buttons to all show without
		//having to resize the window every time the program runs.
		if (OperatingSystem.IsWindows())
		{
			this.MinimumSize = new Size(555, 475);
