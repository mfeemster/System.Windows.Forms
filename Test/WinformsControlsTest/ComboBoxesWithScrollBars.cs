...
public partial class ComboBoxesWithScrollBars : Form
{
	...
	public ComboBoxesWithScrollBars()
	{
		...
		origHeight = comboBox1.DropDownHeight;
	}
	...
	protected override void OnLoad(EventArgs e)
	{
		...
		maxDropDownItemsUpDown1.ValueChanged += (s, e) => { comboBox1.DropDownHeight = origHeight; comboBox1.MaxDropDownItems = (int)maxDropDownItemsUpDown1.Value; };
		maxDropDownItemsUpDown2.ValueChanged += (s, e) => { comboBox2.MaxDropDownItems = (int)maxDropDownItemsUpDown2.Value; };
		maxDropDownItemsUpDown3.ValueChanged += (s, e) => { comboBox3.DropDownHeight = origHeight; comboBox3.MaxDropDownItems = (int)maxDropDownItemsUpDown3.Value; };
		...
		comboBox1.MaxDropDownItems = 123;
		base.OnLoad(e);
	}
